  ...
  return (
    ...
    >
      ...
      <div className="relative">
        ...
        {steps.length > 0 && (
          <div className={`mt-4 grid gap-2.5 ${half ? 'sm:grid-cols-3' : 'sm:grid-cols-3'}`}>
            {steps.map((s, i) => (
        ...
        {cta && (
          <Link
            to={cta.to}
            className={`mt-4 inline-flex items-center justify-center gap-1.5 rounded-xl border px-3 py-2 text-xs font-semibold text-foreground transition-colors hover:border-primary/40 ${a.ring} bg-secondary/40`}
          >
            {cta.label}
