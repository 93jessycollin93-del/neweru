...
export default function EruHero() {
  return (
    <section
      ...
      className="eru-theme-card eru-cta-accent relative overflow-hidden rounded-2xl border border-border p-4 sm:p-5 eru-enter"
    >
      ...
      <div
        aria-hidden="true"
        className="pointer-events-none absolute -bottom-16 -left-10 h-36 w-36 rounded-full bg-cyan-500/10 blur-3xl"
      />
      ...
      <div className="relative flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div className="min-w-0">
          ...
          <h1 className="mt-2 text-lg font-bold leading-tight text-foreground sm:text-xl md:text-2xl">
        ...
        <Link
          to="/about"
          className="inline-flex flex-shrink-0 items-center justify-center gap-1.5 self-start rounded-xl border border-primary/30 bg-primary/10 px-3 py-2 text-xs font-semibold text-primary hover:bg-primary/15 sm:self-auto"
        >
          Learn more
